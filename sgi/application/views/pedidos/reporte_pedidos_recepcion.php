...
<ul class="nav navbar-nav">
           ...
           <a tabindex="-1" href="<?php echo site_url();?>/pedidos/generar_reporte2"><span class="glyphicon glyphicon-chevron-left"> VOLVER </span></a>
          </li>
...
<center><h3 class="panel-title"><b><? echo $titulo_reporte; ?></b></h3></center>
  ...
  <div class="panel-body">
		<div class="row">
		<div class="col-lg-6"><label>Tipo Recepcion:&nbsp;</label><?php echo  $tipo; ?>	</div><!--Fin col-lg-6-->
		<div class="col-lg-6"><label>N&uacute;mero:&nbsp;</label><?php echo  $numero; ?>	</div><!--Fin col-lg-6-->
		<div class="col-lg-12">
