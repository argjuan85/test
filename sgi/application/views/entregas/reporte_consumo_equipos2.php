...
<ul class="nav navbar-nav">
           ...
           <a tabindex="-1" href="<?php echo site_url();?>/entregas/generar_reporte2"><span class="glyphicon glyphicon-chevron-left"> VOLVER </span></a>
          </li>
...
<center><h3 class="panel-title"><b><? echo $titulo_reporte; ?></b></h3></center>
  ...
  <div class="panel-body">
		<div class="row">
		<div class="col-lg-6"><label>Sede:&nbsp;</label><?php echo  $sede; ?>	</div><!--Fin col-lg-6-->
...
<div class="col-lg-6">		<label>Fecha Hasta:&nbsp;</label><?php echo  $hasta; ?>	</div>
		...
		<tbody>
			...
			foreach ($query_ad as $row)
			{
				...
				echo "<td align='center'>". $this->entregas_model->calcula_rechazado_insumo($row['id'],$fecha_desde,$fecha_hasta)  ."</td>";
