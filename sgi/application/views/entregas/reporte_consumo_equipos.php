...
<ul class="nav navbar-nav">
           ...
           <a tabindex="-1" href="<?php echo site_url();?>/entregas/generar_reporte"><span class="glyphicon glyphicon-chevron-left"> VOLVER </span></a>
          </li>
...
<center><h3 class="panel-title"><b><? echo $titulo_reporte; ?></b></h3></center>
  ...
  <div class="panel-body">
		<div class="row">
		<div class="col-lg-6"><label>Codigo de Equipo:&nbsp;</label><?php echo  $equipo; ?>	</div><!--Fin col-lg-6-->
...
<div class="col-lg-6">		<label>Fecha Hasta:&nbsp;</label><?php echo  $hasta; ?>	</div>
		...
		<thead>
			...
			<tr>
				...
				<td align="center" class="disp"><b>Cantidad</b></td>
				    <td align="center" class="disp"><b>Rechazados</b></td>
				<td align="center" class="disp"><b>Rendimiento</b></td>
			...
			<td align="center"><input type="text" name="search_engine1" value="" class="search_init" /></td>
		...
		<tbody>
			...
			foreach ($query_ad as $row)
			{
				...
				echo "<td align='center'>". $this->entregas_model->calcula_rechazados($codigo_equipo,$row['id'],$fecha_desde,$fecha_hasta)  ."</td>";
				echo "<td align='center'>". $this->entregas_model->obtener_rendimiento($codigo_equipo,$row['id'],$fecha_desde,$fecha_hasta) ."</td>";
				echo "</tr>";
			}
